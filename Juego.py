...
# Ahora sí, crear el fondo animado
...
# Inicializar el gestor de sprites
sprite_manager = SpriteManager()

# Cargar los sprites desde los archivos SVG
try:
    svg_nave = open(os.path.join(IMG_PATH, 'nave-sprite.svg'), 'r').read()
    sprite_nave = sprite_manager.cargar_svg('nave', svg_nave)
    sprite_nave_original = sprite_nave  # Guardar el sprite original para escalado
    ...
    # Usar sprites de respaldo en SpriteManager.py
    sprite_nave = sprite_manager._crear_sprite_nave()
    sprite_manager.sprites['nave'] = sprite_nave
    
    sprite_enemigo = sprite_manager._crear_sprite_enemigo()
    sprite_manager.sprites['enemigo'] = sprite_enemigo
    
    sprite_jefe = sprite_manager._crear_sprite_jefe()
    sprite_manager.sprites['jefe'] = sprite_jefe
    
    sprite_bala = sprite_manager._crear_sprite_bala()
    sprite_manager.sprites['bala'] = sprite_bala
    
    sprite_bala_enemiga = sprite_manager._crear_sprite_bala_enemiga()
    sprite_manager.sprites['bala_enemiga'] = sprite_bala_enemiga
    
    sprite_explosion = sprite_manager._crear_sprite_explosion()
    sprite_manager.sprites['explosion'] = sprite_explosion
    
    sprite_nave_verde = sprite_manager._crear_sprite_nave_verde()  
    sprite_manager.sprites['nave_verde'] = sprite_nave_verde
    
    sprite_nave_roja = sprite_manager._crear_sprite_nave_roja()
    sprite_manager.sprites['nave_roja'] = sprite_nave_roja
    
    sprite_nave_amarilla = sprite_manager._crear_sprite_nave_amarilla()
    sprite_manager.sprites['nave_amarilla'] = sprite_nave_amarilla
    
    sprite_nave_naranja = sprite_manager._crear_sprite_nave_naranja()
    sprite_manager.sprites['nave_naranja'] = sprite_nave_naranja
...
balas_enemigas = []
jefe = None
nave = Nave(ANCHO // 2 - 25, ALTO - 60)  # Instancia inicial de la nave 
nave.sprite = sprite_nave  # Asignar el sprite a la nave
mundo = 1
